...
def calc_avg(dict):
    """makes the avg of the top n (=3) words with the dict's highest percentage"""
...
def calc_sim():
    ...
    freq_cour = FreqDist(courage_dict)
    freq_pap = FreqDist(paper_dict)
    freq_appr = FreqDist(apprehension_dict)
    freq_sharp = FreqDist(sharpener_dict)

    print("The similarity of courage (generic, abstract) is " + str(courage_sim))
    print("The five most frequent words are: " + str(freq_cour.most_common(most_freq_words)) + "\n")

    print("The similarity of paper (generic, real) is " + str(paper_sim))
    print("The five most frequent words are: " + str(freq_pap.most_common(most_freq_words)) + "\n")

    print("The similarity of apprehension (specific, abstract) is " + str(appr_sim))
    print("The five most frequent words are: " + str(freq_appr.most_common(most_freq_words)) + "\n")

    print("The similarity of sharpener (specific, real) is " + str(sharp_sim))
    print("The five most frequent words are: " + str(freq_sharp.most_common(most_freq_words)) + "\n")
